...
module.exports.decrypt = (options) => {
  try {
    ...
    const encryptedFile = options.outputFile || '.env.enc'
...
/**
 *
 * @param {{secret: string, inputFile: string, outputFilePath: string, encryptionAlgo: string, ivLength: number}} options description
 */
